...
Mappings.keymap = {
	...
	{'l',	'nxo',	{'flash-jump'},	kind='m',	desc='Flash Jump'	        },
    {'L',	'nxo',	{'flash-ts'},	kind='m',	desc='Flash Treesitter'	    },
    -- u
	...
	{'h',	'nx',	'<nop>',	    kind=' ',	desc=''	                    },
	{'H',	'nx',	'<nop>',	    kind=' ',	desc=''	                    },
	{'n',	'nxo',	{'flash-f'},	kind='m',	desc='Find char'	        },
    {'N',	'nxo',	{'flash-F'},	kind='m',	desc='rFind char'	        },
    {'e',	'n',	'c',	        kind='a',	desc='Erase (change)'       },
	{'E',	'n',	'C',	        kind='a',	desc='Erase line (change)'  },
    -- i
    -- o
    -- z
    -- Z
